...
class FreeConvection_Internal(NumericalModel):
	...
	TWallTop = Quantity('Temperature', default = (50, 'degC'), label = 'temeprature top',
					show = '(self.geomConf == "HL") || (self.geomConf == "IL")')
