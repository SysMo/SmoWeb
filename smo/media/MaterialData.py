...
Solids = OrderedDict((
	...
	('StainlessSteel304', {'label' : 'stainless steel 304', 
		...
		'thermalCond_T': {
			'T': [20.0 , 50.0 , 75.0 , 100.0 , 125.0 , 150.0 , 175.0 , 200.0 , 225.0 , 250.0 , 275.0 , 300.0],
			'cond': [1.95, 5.8, 7.94, 9.4, 10.6, 11.5, 12.3, 13, 13.6, 14.1, 14.5, 14.9],
		},
		'heatCapacity_T': {
			'T': [20.0 , 50.0 , 75.0 , 100.0 , 125.0 , 150.0 , 175.0 , 200.0 , 225.0 , 250.0 , 275.0 , 300.0],
...
# Incompressible water-mass-based binary mixtures included in CoolProp
# See: http://www.coolprop.org/fluid_properties/Incompressibles.html
IncompressibleSolutions = OrderedDict((
	("FRE", "Freezium, Potassium Formate"),
	("IceEA", "Ice slurry with Ethanol"),
	("IceNA", "Ice slurry with NaCl"),
	("IcePG", "Ice slurry with Propylene Glycol"),
	("LiBr", "Lithium-bromide solution - aq"),
	("MAM", "Ammonia (NH3) - aq"),
	#("MAM2", "Melinder, Ammonia"),
	("MCA", "Calcium Chloride (CaCl2) - aq"),
	#("MCA2", " 	Melinder, Calcium Chloride"),
	("MEA", "Ethyl Alcohol (Ethanol) - aq"),
	#("MEA2", "Melinder, Ethanol"),
	("MEG", "Ethylene Glycol - aq"),
	#("MEG2", "Melinder, Ethylene Glycol"),
	("MGL", "Glycerol - aq"),
	#("MGL2", "Melinder, Glycerol"),
	("MKA", "Potassium Acetate (CH3CO2K) - aq"),
	#("MKA2", "Melinder, Potassium Acetate"),
	("MKC", "Potassium Carbonate (K2CO3) - aq"),
	#("MKC2", "Melinder, Potassium Carbonate"),
	("MKF", "Potassium Formate (CHKO2) - aq"),
	("MLI", "Lithium Chloride (LiCl) - aq"),
	("MMA", "Methyl Alcohol (Methanol) - aq"),
	#("MMA2", "Melinder, Methanol"),
	("MMG", "MgCl2 - aq"),
	#("MMG2", "Melinder, Magnesium Chloride"),
	("MNA", "Sodium Chloride (NaCl) - aq"),
	#("MNA2", "Melinder, Sodium Chloride"),
	("MPG", "Propylene Glycol - aq"),
	("MPG2", "Melinder, Propylene Glycol"),
	("VCA", "VDI, Calcium Cloride"),
	("VKC", "VDI, Potassium Carbonate"),
	("VMA", "VDI, Methanol"),
	("VMG", "VDI, Magnesium Chloride"),
	("VNA", "VDI, Sodium Chloride"),
))